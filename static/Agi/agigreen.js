function openPopupagi() {
    ...
    if (commande === "") {
        ...
        document.getElementById("popupMessage").innerText = "Aucun numéro de commande renseigné";
        ...
        $.ajax({
            ...
            error: function (xhr, status, error) {
                ...
                document.getElementById("popupTitle").innerText = "Erreur";
                document.getElementById("popupMessage").innerText = "Erreur lors de la vérification de la commande 3 ";
                document.getElementById("icon").src = "../static/Contact/no_icon.png";
...
function livrerCommande(commande) {
    ...
    $.ajax({
        ...
        error: function (xhr, status, error) {
            // Afficher une erreur en cas d'échec de la requête
            document.getElementById("popupTitle").innerText = "Erreur";
            document.getElementById("popupMessage").innerText = "Erreur lors de la livraison de la commande 4 ";
            document.getElementById("icon").src = "../static/Contact/no_icon.png";
             // Afficher la popup
            popup.classList.add("popup-open");
